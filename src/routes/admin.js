...
router.post('/create', isAdminRoute, upload.single('imagenes'), validacionesProductos, adminController.save);
router.get('/detail/:id', isAdminRoute,adminController.show);
router.put('/:id/edit', isAdminRoute, upload.single('imagenes'), validacionesProductos, adminController.update);
